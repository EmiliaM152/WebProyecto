...
namespace ReactVentas.Controllers
{
    ...
    public class SessionController : ControllerBase
    {
        ...
        public async Task<IActionResult> Login([FromBody] Dtosesion request)
        {
            ...
            try
            {
                // Buscar un usuario en la base de datos que coincida con el correo y la contraseña proporcionados
                ...
                // Si no se encuentra ningún usuario, se inicializa un objeto Usuario vacío
                if (usuario == null)
                    usuario = new Usuario();
